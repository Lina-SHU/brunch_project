  ...
  <Form v-slot="{ errors }" class="p-2 text-primary" @submit="onSubmit">
    ...
    <div class="row g-3 mb-3">
      <div class="col-md-6">
        ...
        <Field name="取餐日期" class="form-select border-0 bg-secondary" as="select" :class="{ 'is-invalid': errors['取餐日期'] }" rules="required" placeholder="請選擇取餐日期" v-model="user.getDate">
      ...
      <div class="col-md-6">
        ...
        <Field name="取餐時間" class="form-select border-0 bg-secondary" as="select" :class="{ 'is-invalid': errors['取餐時間'] }" rules="required" placeholder="請選擇取餐時間" v-model="user.getTime">
    ...
    <div class="mb-3">
      ...
      <Field name="付款方式" class="form-select border-0 bg-secondary" as="select" :class="{ 'is-invalid': errors['付款方式'] }" rules="required" placeholder="請選擇付款方式" v-model="user.payment_method">
